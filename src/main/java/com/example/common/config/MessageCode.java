...
public enum MessageCode implements ICode {
    ...
    // 驗證碼相關(3000-4000)
    VERIFICATION_CODE_EXPIRED(3001, "VERIFICATION_CODE_EXPIRED碼過期"),
    LAST_VERIFICATION_CODE_VALID(3002, "LAST_VERIFICATION_CODE_VALID"),
    VERIFICATION_CODE_DUPLICATE(3003, "VERIFICATION_CODE_DUPLICATE"),
    VERIFICATION_CODE_INVALID(3004, "VERIFICATION_CODE_INVALID")
    ;
